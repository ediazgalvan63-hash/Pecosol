...
SQL_PATH = pathlib.Path('pecosol_db_fresh.sql')
...
def main():
    ...
    try:
        with conn.cursor() as cur:
            ...
            tables_to_drop = ['audit_logs', 'employees', 'products', 'purchases', 'sales', 'stock_movements', 'users', 'work_orders']
            ...
            print(f'\nIMPORT COMPLETE: {executed} statements executed')
    finally:
        conn.close()
